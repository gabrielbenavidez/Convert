...
Program : Convert
Purpose : to convert the given file into hexidecimal and decimal and determine RAM chip number.
...
public class Convert
{
	...
	public void checkChip(ArrayList <Long> deci )// checks what chip has an error
	{
		...
		int x = 0;
			...
			for (x = 0; x < deci.size();x++)// loops through each decimal number
			{
	...
	public static void main(String args[])
    {
		...
		proj2.openFile(file);//sending file to open method
    }  
